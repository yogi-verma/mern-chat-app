        ...
        <div className='flex items-center justify-center min-h-screen px-4'>
            <div className='flex flex-col md:flex-row items-center w-full max-w-4xl mx-auto'>
                <div className='flex flex-col items-start justify-start mr-0 md:mr-10 mb-6 md:mb-0 w-full md:w-1/2'>
                    <div className='flex items-center text-blue-500 text-4xl md:text-5xl ml-0 font-extrabold'>
                        <IoLogoWechat className='mr-2' /> {/* Add margin-right to space the icon from the text */}
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            <input
                                ...
                                className='w-full input h-11 bg-white my-4 border border-gray-400 text-gray-700'
                                value={username}
